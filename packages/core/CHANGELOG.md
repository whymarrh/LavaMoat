...
## [19.0.0](https://github.com/whymarrh/LavaMoat/compare/lavamoat-core-v18.0.1...lavamoat-core-v19.0.0) (2026-04-13)


### ⚠ BREAKING CHANGES

* Node.js v18 is no longer supported.
* **core:** stop overwriting the policy file while loading. ([#1835](https://github.com/whymarrh/LavaMoat/issues/1835))

### Features

* **core:** add "redefine" global policy value to schema ([09d78ba](https://github.com/whymarrh/LavaMoat/commit/09d78badd3b3cc2e982ce690e84133d9959f43b2)), closes [#1583](https://github.com/whymarrh/LavaMoat/issues/1583)
* **core:** add informative errors when the result of policy merge contains invalid entries ([#1848](https://github.com/whymarrh/LavaMoat/issues/1848)) ([fefd457](https://github.com/whymarrh/LavaMoat/commit/fefd457d53c2944fe3d2ee719cd741f5eafb8987))
* **core:** export endowmentsToolkit from the root ([4abfade](https://github.com/whymarrh/LavaMoat/commit/4abfade71ca4f7473ead3d2c48426dd4a7293f76))
* **core:** export MODULE_REFS constant; fix strict mode in function wrapper ([338caaf](https://github.com/whymarrh/LavaMoat/commit/338caaf82a2beae7273ff65c3828796e99a4b227))
* **core:** policy sorting cli for cleaner sort order migration ([#1467](https://github.com/whymarrh/LavaMoat/issues/1467)) ([b2cf7c3](https://github.com/whymarrh/LavaMoat/commit/b2cf7c33fe59adcab888c72164818bd590cf11c7))
* **core:** relax scuttling by skipping intrinsics ([#1645](https://github.com/whymarrh/LavaMoat/issues/1645)) ([5040521](https://github.com/whymarrh/LavaMoat/commit/5040521a089e10a03dcb882d37b0129b8d64a2c3))
* **core:** second param to mergePolicy is now explicitly optional ([f2302aa](https://github.com/whymarrh/LavaMoat/commit/f2302aa1e805456e17bf966193676c1466bb98ca))
* **core:** sort policy in a diff-friendly way ([#1350](https://github.com/whymarrh/LavaMoat/issues/1350)) - sort order remains unchanged even if path to dependency changed. ([4af8ad7](https://github.com/whymarrh/LavaMoat/commit/4af8ad7559e1ab12c541488cf537ecc18ce0d6dc))
* **core:** support Firefox contentscript shenanigans with cross-realm window prototypes ([#1786](https://github.com/whymarrh/LavaMoat/issues/1786)) ([271598f](https://github.com/whymarrh/LavaMoat/commit/271598f59161ba83f525a3d340916b32e6f4a96a))
* **core:** support untrusted entrypoints ([36018de](https://github.com/whymarrh/LavaMoat/commit/36018dea2bbe9b7d16588e0333974dd98ee2d02d))
* **node:** add support in scuttling ([#1627](https://github.com/whymarrh/LavaMoat/issues/1627)) ([587644f](https://github.com/whymarrh/LavaMoat/commit/587644fb8ec59499b181d0e8c8d2660257d04015))
...
* **core:** fix broken references, type checking for mergePolicy.js ([b08adef](https://github.com/whymarrh/LavaMoat/commit/b08adef9bdfaf19e3e5951cfe2019271d689124a))
* **core:** fix policy narrowing logic in the policy merge  ([#1843](https://github.com/whymarrh/LavaMoat/issues/1843)) ([ea5f3d4](https://github.com/whymarrh/LavaMoat/commit/ea5f3d46aa8db8ee8e51115ca4b46c5fd00a89b6))
* **core:** ignore global Function in policy ([55f8c7b](https://github.com/whymarrh/LavaMoat/commit/55f8c7bd07de7f51fc2db81972f6f7d447f33e9e))
* **core:** make the wrapper for global functions strict ([#1898](https://github.com/whymarrh/LavaMoat/issues/1898)) ([8c0205c](https://github.com/whymarrh/LavaMoat/commit/8c0205c5bbc0a6f70a6a86073f9b9d9ef100421f))
* **core:** move ses to production dependencies ([27c0e8b](https://github.com/whymarrh/LavaMoat/commit/27c0e8b191c8a8145e90dd5487cd09cad75500de))
* **core:** noSharedPrototype case in copyWrappedGlobals must include non-enumerable properties ([592f96e](https://github.com/whymarrh/LavaMoat/commit/592f96e1291aa31cfd6942493e40563b8680b871))
* **core:** replace merge-deep with bespoke policy merge implementation ([#1909](https://github.com/whymarrh/LavaMoat/issues/1909)) ([1eb97f6](https://github.com/whymarrh/LavaMoat/commit/1eb97f6e92e55377d76aafcd8c9df47fbaa233a4))
* **core:** stop overwriting the policy file while loading. ([#1835](https://github.com/whymarrh/LavaMoat/issues/1835)) ([db57c1c](https://github.com/whymarrh/LavaMoat/commit/db57c1c3a8a8822733b887edec633e3ce1f1177a))
* **core:** transfer prototype over to a wraped function ([#1847](https://github.com/whymarrh/LavaMoat/issues/1847)) ([14e3c66](https://github.com/whymarrh/LavaMoat/commit/14e3c66957a8700fbf3a423e67f5785e7172e008))
* **core:** untangle another tsc confusion in generating .d.ts files ([#1867](https://github.com/whymarrh/LavaMoat/issues/1867)) ([5ce9b96](https://github.com/whymarrh/LavaMoat/commit/5ce9b9613d5b1601f24a320a07e7e8eccb96aa18))
* **core:** update vendored lockdown.umd.js ([41a2d54](https://github.com/whymarrh/LavaMoat/commit/41a2d541f80956b2623d6176d8580825df29b52d))
...
* **deps:** update babel monorepo to v7.26.10 ([#1561](https://github.com/whymarrh/LavaMoat/issues/1561)) ([2757717](https://github.com/whymarrh/LavaMoat/commit/275771754578647346da1ece0f86afaabdd5de36))
* **deps:** update babel monorepo to v7.26.5 ([#1501](https://github.com/whymarrh/LavaMoat/issues/1501)) ([4e1e19d](https://github.com/whymarrh/LavaMoat/commit/4e1e19d4f585fb730f32b581ed44d448b9d03122))
...
* **deps:** update babel monorepo to v7.27.3 ([#1672](https://github.com/whymarrh/LavaMoat/issues/1672)) ([72cb642](https://github.com/whymarrh/LavaMoat/commit/72cb6424bb5acb16655562deaefff8ef2cf2168e))
* **deps:** update definitelytyped ([#1574](https://github.com/whymarrh/LavaMoat/issues/1574)) ([6c2d54e](https://github.com/whymarrh/LavaMoat/commit/6c2d54e851ea24a9482a52018b5e0d84716f87b6))
